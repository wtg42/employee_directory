    ...
    <div class="container mx-auto">
        <div class="max-w-md mx-auto my-10 bg-white p-5 rounded-md shadow-sm">
            <div class="text-center">
                <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">新增部門</h1>
            </div>
            <div class="m-7">
                <form wire:submit.prevent="submitForm">
                    ...
                    <div class="mb-6">
                        <label for="dept_name"
                            class="block mb-2 text-sm text-gray-600 dark:text-gray-400">部門名稱</label>
                        <input wire:dirty.class="text-red-500" wire:model.lazy="dept_name" type="text"
                            id="dept_name" placeholder="產品事業群 研發中心"
                            class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" />
                        @error('dept_name')<span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
